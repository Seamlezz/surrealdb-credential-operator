...
func createCredentialFixture(ctx context.Context, namespace string) {
	...
	Expect(k8sClient.Create(ctx, &surrealdbv1alpha1.SurrealDBProvider{ObjectMeta: metav1.ObjectMeta{Name: "default-" + namespace}, Spec: surrealdbv1alpha1.SurrealDBProviderSpec{Endpoint: "http://surrealdb:8000", RootCredentialRef: surrealdbv1alpha1.RootCredentialReference{Namespace: namespace, Name: "root"}}})).To(Succeed())
